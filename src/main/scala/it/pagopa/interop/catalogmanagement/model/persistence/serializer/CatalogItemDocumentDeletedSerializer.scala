...
import it.pagopa.interop.catalogmanagement.model.persistence.CatalogItemDocumentDeleted
...
class CatalogItemDocumentDeletedSerializer extends SerializerWithStringManifest {
  ...
  final val className: String = classOf[CatalogItemDocumentDeleted].getName
