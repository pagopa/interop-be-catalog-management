...
import it.pagopa.interop.catalogmanagement.model.persistence.CatalogItemWithDescriptorsDeleted
import it.pagopa.interop.catalogmanagement.model.persistence.serializer.v1._

import java.io.NotSerializableException

class CatalogItemWithDescriptorsDeletedSerializer extends SerializerWithStringManifest {
  ...
  final val className: String = classOf[CatalogItemWithDescriptorsDeleted].getName
