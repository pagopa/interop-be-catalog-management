...
import it.pagopa.interop.catalogmanagement.model.persistence.CatalogItemDocumentAdded
...
class CatalogItemDocumentAddedSerializer extends SerializerWithStringManifest {
  ...
  final val className: String = classOf[CatalogItemDocumentAdded].getName
