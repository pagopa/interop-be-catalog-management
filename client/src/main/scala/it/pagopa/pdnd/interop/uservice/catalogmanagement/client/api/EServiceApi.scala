...
import it.pagopa.pdnd.interop.uservice.catalogmanagement.client.model.EServiceDescriptorState
...
object EServiceApi {
  ...
  def apply(baseUrl: String = "https://gateway.interop.pdnd.dev/pdnd-interop-uservice-catalog-management/}") =
    new EServiceApi(baseUrl)
}

class EServiceApi(baseUrl: String) {

  /** Expected answers:
    *   code 204 :  (EService Descriptor state archived)
  ...
  /** Expected answers:
    ...
    * @param doc
    */
  def createEServiceDocument(eServiceId: String, descriptorId: String, kind: String, description: String, doc: File)(
  ...
  /** Expected answers:
    *   code 204 :  (EService Descriptor state deprecated)
    *   code 400 : Problem (Invalid input)
    *   code 404 : Problem (Not found)
    *
    * Available security schemes:
  ...
  /** Expected answers:
    *   code 204 :  (EService Descriptor state changed in draft)
    *   code 400 : Problem (Invalid input)
    *   code 404 : Problem (Not found)
    *
    * Available security schemes:
  ...
  /** Expected answers:
    ...
    * @param state
    */
  def getEServices(producerId: Option[String] = None, state: Option[EServiceDescriptorState] = None)(implicit
    bearerToken: BearerToken
  ): ApiRequest[Seq[EService]] =
    ApiRequest[Seq[EService]](ApiMethods.GET, baseUrl, "/eservices", "application/json")
      .withCredentials(bearerToken)
      .withQueryParam("producerId", producerId)
      .withQueryParam("state", state)
      .withSuccessResponse[Seq[EService]](200)
      .withErrorResponse[Problem](400)

  /** Expected answers:
    *   code 204 :  (EService Descriptor state published.)
    *   code 400 : Problem (Invalid input)
    *   code 404 : Problem (Not found)
    *
    * Available security schemes:
  ...
  /** Expected answers:
    *   code 204 :  (EService Descriptor state suspended)
    *   code 400 : Problem (Invalid input)
    *   code 404 : Problem (Not found)
    *
    * Available security schemes:
  ...
  )(implicit bearerToken: BearerToken): ApiRequest[EService] =
    ApiRequest[EService](
      ApiMethods.PUT,
      baseUrl,
      "/eservices/{eServiceId}/descriptors/{descriptorId}",
      ...
      .withCredentials(bearerToken)
      .withBody(updateEServiceDescriptorSeed)
      .withPathParam("eServiceId", eServiceId)
      .withPathParam("descriptorId", descriptorId)
      .withSuccessResponse[EService](200)
      .withErrorResponse[Problem](400)
  ...
  )(implicit bearerToken: BearerToken): ApiRequest[EServiceDoc] =
    ApiRequest[EServiceDoc](
      ApiMethods.POST,
      baseUrl,
      ...
      .withCredentials(bearerToken)
      .withBody(updateEServiceDescriptorDocumentSeed)
      .withPathParam("eServiceId", eServiceId)
      .withPathParam("descriptorId", descriptorId)
      .withPathParam("documentId", documentId)
      .withSuccessResponse[EServiceDoc](200)
